...
namespace Hylasoft.Opc.Tests {
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design",
         "CA1001:TypesThatOwnDisposableFieldsShouldBeDisposable", Justification = "Test Class"), TestFixture]
    public class UaTest {
        ...
        public void FailWriteTest() {
            ...
            Assert.Throws<OpcException>(() =>
                _client.Write("Server.ServerStatus.BuildInfo.ManufacturerName", "READ ONLY"));
        }
        ...
        public void UaTestKeepAliveNotifyDisconnect() {
            ...
            client.Connect();
            var i = 0;
            client.ServerConnectionLost += (object sender, EventArgs e) => { i++; };
        ...
        public void DisposeWithoutException() {
            ...
            foreach (var node in nodes) {
                _client.Monitor<object>(node.Tag,
                    (value, unsubscribe) => { Console.WriteLine("{0}:={1}", node.Name, value); });
            }
